...
def setting_pressure(n):
    ...
    p_co[n]   = pressure[n]*f_co[n]/(f_co[n]+f_co2[n]+f_h2[n]+f_h2o[n]+f_meoh[n])
    p_co2[n]  = pressure[n]*f_co2[n]/(f_co[n]+f_co2[n]+f_h2[n]+f_h2o[n]+f_meoh[n])
    p_h2[n]   = pressure[n]*f_h2[n]/(f_co[n]+f_co2[n]+f_h2[n]+f_h2o[n]+f_meoh[n])
    p_h2o[n]  = pressure[n]*f_h2o[n]/(f_co[n]+f_co2[n]+f_h2[n]+f_h2o[n]+f_meoh[n])
    p_meoh[n] = pressure[n]*f_meoh[n]/(f_co[n]+f_co2[n]+f_h2[n]+f_h2o[n]+f_meoh[n])
...
# 1.管型反応器の入口条件を設定,出力
initialize_molar_flow_rate_and_pressure_byPT(80.92,500,0.017,0.173,0.803,0.001,0.005)
# mid-output
